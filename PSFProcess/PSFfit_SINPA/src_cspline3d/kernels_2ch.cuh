...
*/
__global__ void Init_2ch(int NFits, int boxsz, int splineszx, int splineszz, float* g_data, float* g_var, float* g_coeff_PSF,
...
*/
__global__ void LMupdate_2ch(int NFits, char* g_push_flag, int boxsz, int splineszx, int splineszz, float* g_data, float* g_var, float* g_coeff_PSF,
	int warpdeg, int* g_lu, float* g_coeff_R2T,
...
/*!	@brief	<<<ceil(NFits/BLCKSZ), BLCKSZ = 64>>>
			calculate the CRLB	
*/
__global__ void getCRLB_2ch(int NFits, int boxsz, int splineszx, int splineszz, float* g_var, float* g_coeff_PSF, 
	int warpdeg, int* g_lu, float* g_coeff_R2T, 
