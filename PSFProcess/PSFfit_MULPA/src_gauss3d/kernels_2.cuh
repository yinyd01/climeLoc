...
*/
__global__ void PushnPull_2(int NFits, int nchannels, int boxsz, int zrange, float* g_data, float* g_astigs, float* g_xvec)
{
...
*/
__global__ void Init_2_1ch(int NFits, int boxsz, int zrange, float* g_data, float* g_var, float* astigs, float* g_xvec, 
...
__global__ void Init_2_2ch(int NFits, int boxsz, int zrange, float* g_data, float* g_var, float* astigs, 
...
__global__ void LMupdate_2_1ch(int NFits, char* g_iter_push, int boxsz, int zrange, float* g_data, float* g_var, float* astigs,
...
__global__ void LMupdate_2_2ch(int NFits, char* g_iter_push, int boxsz, int zrange, float* g_data, float* g_var, float* astigs, 
...
__global__ void getCRLB_2_1ch(int NFits, int boxsz, float* g_var, float* astigs, float* g_xvec, float* g_CRLB)
{
	const int nnum = 2, nchannels = 1, vnum0 = NDIM + nchannels;
	const int vnum = nnum * vnum0 + nchannels;
	unsigned int Idx = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void getCRLB_2_2ch(int NFits, int boxsz, float* g_var, float* astigs, 
