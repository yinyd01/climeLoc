...
*/
__global__ void PushnPull_3(int NFits, int nchannels, int boxsz, float* g_data, float* PSFsigmax, float* PSFsigmay, float* g_xvec)
{
...
*/
__global__ void Init_3_1ch(int NFits, int boxsz, float* g_data, float* g_var, float* PSFsigmax, float* PSFsigmay, float* g_xvec, 
...
__global__ void Init_3_2ch(int NFits, int boxsz, float* g_data, float* g_var, float* PSFsigmax, float* PSFsigmay, 
...
__global__ void LMupdate_3_1ch(int NFits, char* g_iter_push, int boxsz, float* g_data, float* g_var, float* PSFsigmax, float* PSFsigmay, 
...
__global__ void LMupdate_3_2ch(int NFits, char* g_iter_push, int boxsz, float* g_data, float* g_var, float* PSFsigmax, float* PSFsigmay, 
...
__global__ void getCRLB_3_1ch(int NFits, int boxsz, float* g_var, float* PSFsigmax, float* PSFsigmay, float* g_xvec, float* g_CRLB)
{
	const int nnum = 3, nchannels = 1, vnum0 = NDIM + nchannels;
	const int vnum = nnum * vnum0 + nchannels;
	unsigned int Idx = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void getCRLB_3_2ch(int NFits, int boxsz, float* g_var, float* PSFsigmax, float* PSFsigmay, 
