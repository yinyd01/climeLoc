...
*/
__global__ void PushnPull_6(int NFits, int nchannels, int boxsz, int splinesz, float* g_data, float* coeff_PSF, float* g_xvec)
{
...
*/
__global__ void Init_6_1ch(int NFits, int boxsz, int splinesz, float* g_data, float* g_var, float* coeff_PSF, float* g_xvec,
...
__global__ void Init_6_2ch(int NFits, int boxsz, int splinesz, float* g_data, float* g_var, float* coeff_PSF, 
...
__global__ void LMupdate_6_1ch(int NFits, char* g_iter_push, int boxsz, int splinesz, float* g_data, float* g_var, float* coeff_PSF,
...
__global__ void LMupdate_6_2ch(int NFits, char* g_iter_push, int boxsz, int splinesz, float* g_data, float* g_var, float* coeff_PSF, 
...
__global__ void getCRLB_6_1ch(int NFits, int boxsz, int splinesz, float* g_var, float* coeff_PSF, float* g_xvec, float* g_CRLB)
{
	const int nnum = 6, nchannels = 1, vnum0 = NDIM + nchannels;
	const int vnum = nnum * vnum0 + nchannels;
	unsigned int Idx = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void getCRLB_6_2ch(int NFits, int boxsz, int splinesz, float* g_var, float* coeff_PSF, 
