...
def _fitter_cspline2d1ch(NFits, boxsz, splinesz, data, var, coeff_PSF, PSFsigmax, PSFsigmay, optmethod, iterations):
    ...
    for n in range(1, nmax + 1):
        ...
        if dum_NFits > 0:
            ...
            fitter(dum_NFits, n, boxsz, splinesz, dum_data, dum_var, coeff_PSF, PSFsigmax, PSFsigmay, dum_xvec, dum_crlb, dum_loss, opt, iterations)
...
def cspline2d_1ch(data, var, coeff_PSF, PSFsigmax, PSFsigmay, optmethod, iterations, batsz):
    ...
    for i in range(nbats):
        ...
        dum_xvec, dum_crlb, dum_loss, dum_nnum = _fitter_csspline2d1ch(dum_NFits, boxsz, splineszx, dum_data, dum_var, coeff_PSF, PSFsigmax, PSFsigmay, optmethod, iterations)
...
def _fitter_csspline2d2ch(NFits, boxsz, splinesz, data, var, coeff_PSF, PSFsigmax, PSFsigmay, warpdeg, lu, coeff_R2T, optmethod, iterations):
    ...
    for n in range(1, nmax + 1):
        ...
        if dum_NFits > 0:
            ...
            dum_crlb = np.ascontiguousarray(np.zeros(dum_NFits * vnum), dtype=np.float32)
            dum_loss = np.ascontiguousarray(np.zeros(dum_NFits), dtype=np.float32)
            fitter(dum_NFits, n, boxsz, splinesz, dum_data, dum_var, coeff_PSF, PSFsigmax, PSFsigmay, warpdeg, dum_lu, coeff_R2T, dum_xvec, dum_crlb, dum_loss, opt, iterations)
            dum_xvec = np.reshape(dum_xvec, (dum_NFits, vnum))
            dum_crlb = np.reshape(dum_crlb, (dum_NFits, vnum))
...
def cspline2d_2ch(data, var, coeff_PSF, PSFsigmax, PSFsigmay, lc, uc, coeff_R2T, optmethod, iterations, batsz):
    ...
    for i in range(nbats):
        ...
        dum_xvec, dum_crlb, dum_loss, dum_nnum = _fitter_csspline2d2ch(dum_NFits, boxsz, splineszx, dum_data, dum_var, coeff_PSF, PSFsigmax, PSFsigmay, warpdeg, dum_lu, coeff_R2T, optmethod, iterations)
